		...
		<div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
			<div class="max-w-md">
				...
				<div class="flex justify-center mt-2 flex-nowrap">
					<button
						class="shrink-0 px-4 py-2 text-base font-semibold text-white rounded-lg shadow-md bg-main-textDark-560 hover:bg-main-textLight-560 dark:bg-main-textLight-560 dark:hover:bg-main-textDark-560 focus:outline-none"
						type="button"
						@click="router.go(-1)"
					>
						Go Back
